...
public class Shashi_Number_Guessing_Game {

    public static void main(String[] args) {

        Scanner sc = new Scanner(System.in);
        System.out.println("\n\n");
        System.out.println("                                        [ Welcome to Shashi_Number_Guessing_Game ]                                         ");
        System.out.println("                                        -------------------------------------------                                        ");
        System.out.println("\n");
        ...
        while (true) {
            while (s == 1) {
                ...
                System.out.println("                                        [ Welcome Back to Shashi_Number_Guessing_Game ]                                         ");
                System.out.println("                                        ------------------------------------------------                                        ");
